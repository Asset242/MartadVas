                            ...
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                        <a class="dropdown-item" href="{{ route('categories.all') }}">View More</a>
                                    </div>
                                </div>
                            </div>
                            <p class="mb-1">All Partners</p>
                            <h4 class="card-title mb-3" style="font-size: 22px">{{ $userCount }} Partners</h4>
                   ...
                   <div class="col-lg-4 col-md-4 col-6 mb-6">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <h4 class="card-title mb-3" style="font-size: 22px">{{ $productsCount }} Products</h4>
                            {{-- <small class="text-success fw-medium"><i class='bx bx-up-arrow-alt'></i> +72.80%</small> --}}
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                                        <a class="dropdown-item"  href="{{ route('tables-basic') }}">View More</a>
                                    </div>
                                </div>
                            </div>
                            <p class="mb-1">All Users</p>
                            <h4 class="card-title mb-3" style="font-size: 22px">{{ $postCount }} Customers</h4>
                ...
                <div class="col-lg-4 col-md-4 col-6 mb-6">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <h4 class="card-title mb-3" style="font-size: 22px"> $80,000</h4>
                            {{-- <small class="text-success fw-medium"><i class='bx bx-up-arrow-alt'></i> +72.80%</small> --}}
                        </div>
                    </div>
                </div>
                   ...
                   <div class="col-lg-4 col-md-4 col-6 mb-6">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <h4 class="card-title mb-3" style="font-size: 22px">{{ $categoryCount }} Profit Today</h4>
                            {{-- <small class="text-success fw-medium"><i class='bx bx-up-arrow-alt'></i> +72.80%</small> --}}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-6 mb-6">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="mb-1">Revenue</p>
                            <h4 class="card-title mb-3" style="font-size: 22px">{{ $postCount }} Sale's Today</h4>
                            {{-- <small class="text-success fw-medium"><i class='bx bx-up-arrow-alt'></i> +28.42%</small> --}}
                        </div>
                    </div>
                </div>
