                ...
                <div class="d-flex align-items-start row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            ...
                            <a href="{{ route('forms-basic-inputs') }}" class="btn btn-sm btn-outline-primary">See all Transactions
                                </a>
                        </div>
                    </div>
                    <div class="col-sm-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-6">
                            <img src="{{ asset('assets/img/illustrations/handshake.png') }}" height="175"
                ...
                <div class="col-lg-6 col-md-12 col-6 mb-6">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <h4 class="card-title mb-3" style="font-size: 22px">{{ $categoryCount }} Transactions</h4>
                ...
                <div class="col-lg-6 col-md-12 col-6 mb-6">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <h4 class="card-title mb-3" style="font-size: 22px">{{ $postCount }} Users</h4>
