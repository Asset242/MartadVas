            ...
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                  ...
                  <tr>
                      ...
                      <!-- Body (Truncated) -->
                      <td>{!! Str::limit(preg_replace('/^<p>(.*?)<\/p>$/s', '$1', $post->content), 50) !!}</td>


                      <!-- Image -->
                      <td>
                          @if ($post->image)
                              <img src="{{ asset('storage/' . $post->image) }}" alt="Post Image" class="img-thumbnail" width="80">
                          @else
                              <span>No Image</span>
                          @endif
                      </td>
                      ...
                      <td>
                          <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                  <!-- Edit Post -->
                                  <a class="dropdown-item" href="{{ route('edit', $post->id) }}">
