...
use App\Http\Controllers\category\AllCategory;
 ...
 * ------------------------------------------------------------------------
 */
Route::get('/', [LoginBasic::class, 'index'])->name('partner');
Route::post('/partner/login', [PartnerController::class, 'login'])->name('partner.login');
...
Route::middleware('auth:web')->group(function () {
  ...
  Route::get('/posts/{post}/edit', [BasicInput::class, 'edit'])->name('edit');
